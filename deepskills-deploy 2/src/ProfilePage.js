    ...
    >
      ...
      >
        ...
        <AvailableSection>
          ...
          <AvailableGrid>
            {[
              { id: 'graphic-design', title: 'Graphic Designing', path: '/student/new-enrollment', icon: <FaPaintBrush /> },
              { id: 'laravel-mastery', title: 'Full Stack (Laravel)', path: '/student/new-enrollment', icon: <FaRocket /> },
              { id: 'full-stack-react', title: 'Full Stack (React)', path: '/student/new-enrollment', icon: <FaCode /> },
              { id: 'wordpress-mastery', title: 'WordPress Mastery', path: '/student/new-enrollment', icon: <FaWordpress /> }
            ].map(course => (
              <AvailableCard 
                key={course.id} 
                to={course.path}
